    ...
    internal class Spanyol
    {
        ...
        public void Beolvas(string usernameFromMVC)
        {
            ...
            for (int i = 0; i < datas.Length; i++)
            {
                ...
                if (line[2] == "utazás")
                {
                    travel_spain.Add(line[0]);
                    travel_hun.Add(line[1]);
                }
                if (line[2] == "időjárás")
                {
                    weather_spain.Add(line[0]);
                    weather_hun.Add(line[1]);
                }
                if (line[2] == "lakóhely")
                {
                    home_spain.Add(line[0]);
                    home_hun.Add(line[1]);
                }
            }
            Console.WriteLine("--------------------");
        ...
        public void ABC()
        {
            ...
            do
            {
                ...
                {
                    case 1: topic_spain = family_spain;     topic_hun = family_hun;     topic = "család";       break;
                    case 2: topic_spain = it_spain;         topic_hun = it_hun;         topic = "informatika";  break;
                    case 3: topic_spain = travel_spain;     topic_hun = travel_hun;     topic = "utazás";       break;
                    case 4: topic_spain = weather_spain;    topic_hun = weather_hun;    topic = "időjárás";     break;
                    case 5: topic_spain = home_spain;       topic_hun = home_hun;       topic = "lakóhely";     break;
                    case 6:
                ...
                for (int i = 0; i < 5; i++)
                {
                    if (used_index.Count == topic_spain.Count)
                    {
                        used_index.Clear();
                    }
        ...
        public void Akasztofa()
        {
            do
            {
                ...
                switch (serial_number)
                {
                    case 1: word_LIST = family_spain;    topic = "Család";       break;
                    case 2: word_LIST = it_spain;        topic = "Informatika";  break;
                    case 3: word_LIST = travel_spain;    topic = "Utazás";       break;
                    case 4: word_LIST = weather_spain;   topic = "Időjárás";     break;
                    case 5: word_LIST = home_spain;      topic = "Lakóhely";     break;
                    case 6:
                        Console.WriteLine("Köszönjük, hogy velünk tanultál, {0}!", username);
                        return;
                    default:
        ...
        public void SzoParositas()
        {
            ...
            do
            {
                ...
                List<string> Spain_list = new List<string>();
                List<string> Hun_list = new List<string>();
                string topic = "";

                switch (serial_number)
                {
                    case 1: Spain_list = family_spain;  Hun_list = family_hun;  topic = "család";         break;
                    case 2: Spain_list = it_spain;      Hun_list = it_hun;      topic = "informatika";    break;
                    case 3: Spain_list = travel_spain;  Hun_list = travel_hun;  topic = "utazás";         break;
                    case 4: Spain_list = weather_spain; Hun_list = weather_hun; topic = "időjárás";       break;
                    case 5: Spain_list = home_spain;    Hun_list = home_hun;    topic = "lakóhely";       break;
                    case 6:
                        Console.WriteLine("Köszönjük, hogy velünk tanultál, {0}!", username);
                        return;
                    default:
                ...
                for (int i = 0; i < 5; i++)
                {
                    int index = rnd.Next(Spain_list.Count);
                    string word = Spain_list[index];
        ...
        public void SzoKereso()
        {
            ...
            do
            {
                ...
                switch (serial_number)
                {
                    case 1: topic_spain = family_spain;     topic = "család";       break;
                    case 2: topic_spain = it_spain;         topic = "informatika";  break;
                    case 3: topic_spain = travel_spain;     topic = "utazás";       break;
                    case 4: topic_spain = weather_spain;    topic = "időjárás";     break;
                    case 5: topic_spain = home_spain;       topic = "lakóhely";     break;
                    case 6:
                        Console.WriteLine("Köszönjük, hogy velünk tanultál, {0}!", username);
                        return;
                    default:
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    string abc_ordered_words = new string(Word_Char);
        ...
        public void MondatRendezes()
        {
            ...
            List<string> order_spain = new List<string>();
            string[] datas = File.ReadAllLines("mondatok_spanyol.txt");
            for (int i = 0; i < datas.Length; i++)
            {
                string[] line = datas[i].Split(';');
                order_spain.Add(line[0]);
            ...
            do
            {
                ...
                Console.WriteLine(Spain_mixed_sentences);
                UserTip = Console.ReadLine();

                if (UserTip.Split(' ').OrderBy(s => s).SequenceEqual(Spain_mixed_sentences.Split(' ').OrderBy(s => s)))
                {
                    Console.WriteLine("Helyes válasz!");
        ...
        public void Helyesforditas()
        {
            ...
            List<string> sentenceOrderin_Spain = new List<string>();

            string[] datas = File.ReadAllLines("mondatok_spanyol.txt");
            for (int i = 0; i < datas.Length; i++)
            {
                string[] life = datas[i].Split(';');
                sentenceOrderin_Spain.Add(life[0]);
                sentenceOrdering_Hungarian.Add(life[1]);
            }
            ...
            for (int round = 1; round <= rounds; round++)
            {
                ...
                do
                {
                    currentIndex = rnd.Next(0, sentenceOrderin_Spain.Count);
                }
                ...
                do
                {
                    wrongIndex = rnd.Next(0, sentenceOrderin_Spain.Count);
                }
                ...
                string correct_spain_sentences = sentenceOrderin_Spain[currentIndex];

                bool correct_one = rnd.Next(2) == 0;
                string option1 = correct_one ? sentenceOrderin_Spain[currentIndex] : sentenceOrderin_Spain[wrongIndex];
                string option2 = correct_one ? sentenceOrderin_Spain[wrongIndex] : sentenceOrderin_Spain[currentIndex];
                ...
                {
                    Console.WriteLine($" Helytelen válasz! A helyes válasz: {correct_spain_sentences}");
                }
