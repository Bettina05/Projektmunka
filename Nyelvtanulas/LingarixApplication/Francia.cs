namespace Lingarix
{
    internal class Francia
    {
        ...
        List<string> travel_french = new List<string>();
        ...
        public void Beolvas(string usernameFromMVC)
        {
            ...
            for (int i = 0; i < datas.Length; i++)
            {
                ...
                if (line[2] == "család")
                {
                    family_french.Add(line[0]);
                    family_hun.Add(line[1]);
                }
                if (line[2] == "informatika")
                {
                    it_french.Add(line[0]);
                    it_hun.Add(line[1]);
                }
                if (line[2] == "utazás")
                {
                    travel_french.Add(line[0]);
                    travel_hun.Add(line[1]);
                }
                if (line[2] == "időjárás")
                {
                    weather_french.Add(line[0]);
                    weather_hun.Add(line[1]);
                }
                if (line[2] == "lakóhely")
                {
                    home_french.Add(line[0]);
                    home_hun.Add(line[1]);
                }
            }
            Console.WriteLine("--------------------");
        ...
        public void ABC()
        {
            ...
            do
            {
                ...
                {
                    case 1: topic_french = family_french;   topic_hun = family_hun;     topic = "család";         break;
                    case 2: topic_french = it_french;       topic_hun = it_hun;         topic = "informatika";    break;
                    case 3: topic_french = travel_french;   topic_hun = travel_hun;     topic = "utazás";         break;
                    case 4: topic_french = weather_french;  topic_hun = weather_hun;    topic = "időjárás";       break;
                    case 5: topic_french = home_french;     topic_hun = home_hun;       topic = "lakóhely";       break;
                    case 6:
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    do
                    {
                        index = random.Next(topic_french.Count);
                    } 
        ...
        public void Akasztofa() 
        {
            do
            {
                ...
                switch (serial_number)
                {
                    case 1: word_LIST = family_french;  topic = "Család";        break;
                    case 2: word_LIST = it_french;      topic = "Informatika";   break;
                    case 3: word_LIST = travel_french;  topic = "Utazás";        break;
                    case 4: word_LIST = weather_french; topic = "Időjárás";      break;
                    case 5: word_LIST = home_french;    topic = "Lakóhely";      break;
                    case 6:
                        Console.WriteLine("Köszönjük, hogy velünk tanultál, {0}!", username);
                        return;
                    default:
        ...
        public void SzoParositas()
        {
            ...
            do
            {
                ...
                List<string> French_list = new List<string>();
                List<string> Hun_list = new List<string>();
                string topic = "";

                switch (serial_number)
                {
                    case 1: French_list = family_french;    Hun_list = family_hun;  topic = "család";         break;
                    case 2: French_list = it_french;        Hun_list = it_hun;      topic = "informatika";    break;
                    case 3: French_list = travel_french;    Hun_list = travel_hun;  topic = "utazás";         break;
                    case 4: French_list = weather_french;   Hun_list = weather_hun; topic = "időjárás";       break;
                    case 5: French_list = home_french;      Hun_list = home_hun;    topic = "lakóhely";       break;
                    case 6:
                        Console.WriteLine("Köszönjük, hogy velünk tanultál, {0}!", username);
                        return;
                    default:
                ...
                for (int i = 0; i < 5; i++)
                {
                    int index = rnd.Next(French_list.Count);
                    string word = French_list[index];
        ...
        public void SzoKereso()
        {
            ...
            do
            {
                ...
                switch (serial_number)
                {
                    ...
                    case 3: topic_french = travel_french;   topic = "utazás";       break;
        ...
        public void MondatRendezes()
        {
            ...
            List<string> order_french = new List<string>();
            string[] datas = File.ReadAllLines("mondatok_francia.txt");
            for (int i = 0; i < datas.Length; i++)
            {
                string[] line = datas[i].Split(';');
                order_french.Add(line[0]);
            ...
            do
            {
                int randomSelectedSentence_French = rnd.Next(0, order_french.Count());
                string correctSentence_Hungarian = order_hungarian[randomSelectedSentence_French];
                string French_ToBeMixed_sentence = order_french[randomSelectedSentence_French];
                Console.WriteLine(French_ToBeMixed_sentence);
                string[] broken_Word = French_ToBeMixed_sentence.Split(' ');
                string[] French_mixed_words = broken_Word.OrderBy(x => rnd.Next()).ToArray();
                string French_mixed_sentences = string.Join(" ", French_mixed_words);
                Console.WriteLine("Élet:" + Life);
                Console.WriteLine(French_mixed_sentences);
                UserTip = Console.ReadLine();

                if (UserTip.Split(' ').OrderBy(s => s).SequenceEqual(French_mixed_sentences.Split(' ').OrderBy(s => s)))
                {
                    Console.WriteLine("Helyes válasz!");
        ...
        public void Helyesforditas()
        {
            ...
            {
                string[] line = datas[i].Split(';');
                sentenceOrdering_French.Add(line[0]);
